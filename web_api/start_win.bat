...
::
:: 启动内容:
::   1. web_api/server.py  (0.0.0.0:8765，局域网可访问)
...
echo.
echo ====================================================
echo  API server  : http://0.0.0.0:8765
echo  Frontend    : http://0.0.0.0:5173
echo  Launch mode : !LAUNCH_MODE!
echo ====================================================
echo.

start "zhihu API" /D "%PROJECT_DIR%" "!PYTHON!" web_api\server.py ^
  --host 0.0.0.0 --port 8765 --launch-mode !LAUNCH_MODE!
...
echo 两个服务窗口已启动。MAC 访问: http://^<WIN局域网IP^>:5173
echo.
pause
