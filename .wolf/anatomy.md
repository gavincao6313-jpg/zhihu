...
- `sensevoice_probe.py` — lightweight SenseVoice availability/probe helper for Windows validation (~450 tok)
- `zhihuTTS_stream.py` — remote/replay/live stream validation runner, extractor input handling, ffmpeg slicing, chunk reports, manifest writing, URL re-extraction recovery (~5200 tok)
